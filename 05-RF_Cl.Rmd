...
```{r cat-class, fig.cap="Categorical variables \\label{CatClass}", dpi=300, out.width="80%", out.height="80%", fig.align="center", echo = FALSE}
knitr::include_graphics("data/RF/CatClasses.png")
```
